...
export function PrivacyNotice({ onAccept, content }: PrivacyNoticeProps) {
  ...
  const handleAccept = async () => {
    if (!hasRead) {
      toast({
        title: "Please read the privacy notice",
  ...
  return (
    <Card className="p-6 bg-gray-800/50 backdrop-blur-xl border-gray-700">
      <div className="space-y-4">
        <h2 className="text-2xl font-bold text-white">Privacy Notice</h2>
